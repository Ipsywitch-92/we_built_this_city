...
function storageBuild(){
    console.log("Storage Unit is open!");
    buildings++;
    document.getElementById("city").innerHTML="You have " +buildings+ " buildings in your city";
...
function apartBuild(){
    console.log("Apartment has company!")
    buildings++;
    document.getElementById("city").innerHTML="You have " +buildings+ " buildings in your city";
...
function houseBuild(){
    console.log("House lights are on!")
    buildings++;
    document.getElementById("city").innerHTML="You have " +buildings+ " buildings in your city";
    document.getElementById("cityGraphic").innerHTML+="<img src='images/BuildingBlock3.png' alt='House'>";
}
//Fourth Button Challenge Accepted!
function skyScraperBuild(){
    console.log("I hate this song!!")
    buildings++;
    document.getElementById("city").innerHTML="You have " +buildings+ " buildings in your city";
    document.getElementById("cityGraphic").innerHTML+="<img src='images/BuildingTower.png' alt='SkyScraper'>";
}